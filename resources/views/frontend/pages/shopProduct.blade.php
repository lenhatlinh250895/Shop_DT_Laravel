    ...
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active"><a href="shop/{{$ProductTypeShop->Id}}">{{$ProductTypeShop->Name}}</a></li>
                <li class="active">{{$GroupProductShop->Name}}</li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-9 order-2 order-lg-1 order-sm-1">
                ...
                <div class="single-banner shop-page-banner">
                    <a href="#">
                        <img src="{{url('public/images/bg-banner/2.jpg')}}" alt="Li's Static Banner">
                    </a>
                </div>
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="{{url('singleProduct\/').$pr->Id}}">
                                                    <img src="{{url('public/Update/Product')}}/{{$pr->Image}}" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    @foreach($ProductTypeShop->GroupProduct as $gp)
                                                        @if($gp->Id == $pr->GroupProduct_Id)
                                                        <div class="product-review">
                                                            <h5 class="manufacturer">
                                                                <a href="product-details.html">{{$gp->Name}}</a>
                                                            </h5>
                                                    ...
                                                    <div class="price-box">
                                                        <span class="new-price">{{number_format($pr->Price,0,",",".")}} VNĐ</span>
                                                    </div>
                                                </div>
